...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private String testReportFolder = "test-report-output/" + "reprot-" + DateFormatUtils.format(new Date(), "yyyyMMddHHmmss") + "/";
...
//        }
    ...
    private void init(String folder, String suiteName) {
        if (StringUtils.isEmpty(folder) || StringUtils.isEmpty(suiteName)) {
            return;
        }
        ...
        htmlReporter.config().setEncoding("utf-8");  // utf-8 gbk
